"use strict";
//* Types primitivos.
const frase = "Front End"; // Cria uma variável chamada frase que só aceita/recbe string.
const preco = 500; // Cria uma variável chamada preco que só aceita/recbe number.
const condi = preco > 100; // Cria uma variável chamada condi que só aceita/recbe boolean.
//* > Typeof.
