...
*/
const { body } = document; // Está desestruturando o objeto document e pegando apenas a propriedade body dele e atribuindo a uma variável chamada body do tipo HTMLElement
...
function comparaDados(tipo, ...valores) {
...
function comparaNumeros(tipo, ...numeros) {
    if (tipo === "menor") {
