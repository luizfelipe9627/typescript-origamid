...
function getText(selector) {
    const element = document.querySelector(selector); // Seleciona o elemento do DOM passado como parâmetro e armazena na variável element como HTMLElement.
    ...
    if (element) {
        ...
        return [element, element.innerText]; // Retorna um array com o elemento e o texto dentro do elemento.
    }
    else {
