...
// Criado uma interface chamada ProdutoDetalhes que possui duas propriedades, cor e marca, ambas do tipo string.
interface ProdutoDetalhes {
  cor: string;
  marca: string;
}

type Venda = [string, number, string, ProdutoDetalhes]; // Criado um type chamado Venda que é um array com quatro elementos, sendo o primeiro do tipo string, o segundo do tipo number, o terceiro do tipo string e o quarto do tipo ProdutoDetalhes.
