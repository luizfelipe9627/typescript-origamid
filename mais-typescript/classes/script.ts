...
class Filme {
  ...
  readonly genero = "Terror"; // Criado uma propriedade padrão chamada genero.
  ...
  private ano: number | undefined; // A propriedade ano é number ou undefined. Quando utilizar o "?" tem que colocar o "ou(|) undefined".
  ...
  constructor(nome: string, preco: number, ano?: number) {
...
class Quadrado {
  ...
  // O readonly é um modificador que faz com que a propriedade só possa ser lida, ou seja, não pode ser alterada.
  readonly lados = 4; // Criado uma propriedade padrão chamada lados.
...
class Circulo {
  // O readonly é um modificador que faz com que a propriedade só possa ser lida, ou seja, não pode ser alterada.
  readonly PI = Math.PI; // Criado uma propriedade padrão chamada PI.
